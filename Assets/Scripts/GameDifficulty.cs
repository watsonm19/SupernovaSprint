...
{
    public const  int      RocketSprintIndex = 4;
    public static readonly string[] Names      = { "Jog", "Run", "Sprint", "Super Sprint", "Rocket Sprint" };
    public static readonly float[]  TimeLimits = { 150f, 130f, 120f, 116f, 113f };
    public static readonly string[] TimeLabels = { "2:30", "2:10", "2:00", "1:56", "1:53" };
